...
import {getOrders, updateStatus} from 'src/redux/store/action/supplier';
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item
                    ...
                    >
                      ...
                      <MenuItem value="EN_ROUTED">EN_ROUTE</MenuItem>
                ...
                {filteredData
                  ...
                  .map((item) => (
                    <TableRow key={item.id}>
                      ...
                      <TableCell>
                        {["DELIVERED", "RECEIVED", "APPROVED", "DENIED", "REJECTED"].includes(item.status) ? (
